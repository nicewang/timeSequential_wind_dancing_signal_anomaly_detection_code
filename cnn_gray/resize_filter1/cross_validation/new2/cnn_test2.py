...
with tf.Session() as sess:
    ...
    if os.path.exists('validate_acc/count_abnormal_train.txt'):
        data_tmp = np.genfromtxt('validate_acc/count_abnormal_train.txt')
        ...
        np.savetxt('validate_acc/count_abnormal_train.txt', data)
    else:
