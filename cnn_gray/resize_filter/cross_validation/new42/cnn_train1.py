...
def inference(input_tensor, train, regularizer):
    with tf.variable_scope('layer1-conv1'):
        conv1_weights = tf.get_variable("weight", [3, 3, 1, 128],
    ...
    with tf.variable_scope("layer3-conv2"):
        conv2_weights = tf.get_variable("weight", [3, 3, 128, 256],
                                        initializer=tf.truncated_normal_initializer(stddev=0.1))
        # 可视化观看变量
    ...
    with tf.variable_scope('layer7-fc3'):
        fc32_weights = tf.get_variable("weight", [512, 256],
                                      initializer=tf.truncated_normal_initializer(stddev=0.1))
        ...
        fc32_biases = tf.get_variable("bias", [256], initializer=tf.constant_initializer(0.1))
    ...
    with tf.variable_scope('layer8-fc4'):
        fc3_weights = tf.get_variable("weight", [256, 2],
                                      initializer=tf.truncated_normal_initializer(stddev=0.1))
        ...
        logit = tf.matmul(fc32, fc3_weights) + fc3_biases
