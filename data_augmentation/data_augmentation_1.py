...
for i in range(abnormal_count):
    ...
    data_tmp_11 = data_tmp_11.reshape(1, 60)
    data_tmp_21 = data_tmp_21.reshape(1, 60)
    data_tmp_31 = data_tmp_31.reshape(1, 60)
    data_tmp_41 = data_tmp_41.reshape(1, 60)
    data_tmp_51 = data_tmp_51.reshape(1, 60)
    data_tmp_12 = data_tmp_12.reshape(1, 60)
    data_tmp_22 = data_tmp_22.reshape(1, 60)
    data_tmp_32 = data_tmp_32.reshape(1, 60)
    data_tmp_42 = data_tmp_42.reshape(1, 60)
    data_tmp_52 = data_tmp_52.reshape(1, 60)
