...
for i in range(labels.shape[0]):
    if labels[i] == 1:
        ...
        data_tmp = data_tmp.reshape(1,5,50)
        data_tmp_a = data_tmp_a.reshape(1, 5, 50)
        data_tmp_b = data_tmp_b.reshape(1, 5, 50)
        data_tmp_c = data_tmp_c.reshape(1, 5, 50)
        if data_origin == []:
...
for i in range(abnormal_count):
    ...
    data_tmp_0 = data_tmp_0.reshape(1, 250)
    data_tmp_1 = data_tmp_1.reshape(1, 250)
    data_tmp_2 = data_tmp_2.reshape(1, 250)
    data_tmp_3 = data_tmp_3.reshape(1, 250)
    data_tmp_4 = data_tmp_4.reshape(1, 250)
    data_tmp_5 = data_tmp_5.reshape(1, 250)

    # 对增广后的数据再翻转
    data_tmp_11 = np.flip(data_tmp_1, axis=0)
    data_tmp_21 = np.flip(data_tmp_2, axis=0)
    data_tmp_31 = np.flip(data_tmp_3, axis=0)
    data_tmp_41 = np.flip(data_tmp_4, axis=0)
    data_tmp_51 = np.flip(data_tmp_5, axis=0)
    data_tmp_12 = np.flip(data_tmp_1, axis=1)
    data_tmp_22 = np.flip(data_tmp_2, axis=1)
    data_tmp_32 = np.flip(data_tmp_3, axis=1)
    data_tmp_42 = np.flip(data_tmp_4, axis=1)
    data_tmp_52 = np.flip(data_tmp_5, axis=1)
    data_tmp_11 = data_tmp_11.reshape(1, 250)
    data_tmp_21 = data_tmp_21.reshape(1, 250)
    data_tmp_31 = data_tmp_31.reshape(1, 250)
    data_tmp_41 = data_tmp_41.reshape(1, 250)
    data_tmp_51 = data_tmp_51.reshape(1, 250)
    data_tmp_12 = data_tmp_12.reshape(1, 250)
    data_tmp_22 = data_tmp_22.reshape(1, 250)
    data_tmp_32 = data_tmp_32.reshape(1, 250)
    data_tmp_42 = data_tmp_42.reshape(1, 250)
    data_tmp_52 = data_tmp_52.reshape(1, 250)

    if i == 0:
        data_all = np.row_stack((data_tmp_0, data_tmp_1, data_tmp_2, data_tmp_3, data_tmp_4, data_tmp_5,
                                 data_tmp_11, data_tmp_21, data_tmp_31, data_tmp_41, data_tmp_51,
                                 data_tmp_12, data_tmp_22, data_tmp_32, data_tmp_42, data_tmp_52))
    else:
...
data_flip_a = data_flip_a.reshape(abnormal_count,250)
data_flip_b = data_flip_b.reshape(abnormal_count,250)
data_flip_c = data_flip_c.reshape(abnormal_count,250)
data_new = np.row_stack((data_new, data_flip_a, data_flip_b, data_flip_c))
labels_new = labels
labels_new = labels_new.reshape(labels.shape[0],1)
for i in range(abnormal_count*19):
...
np.savetxt("training_fr_timeFreq_new_1/training data.txt", data_new)
np.savetxt("training_fr_timeFreq_new_1/labels.txt", labels_new)