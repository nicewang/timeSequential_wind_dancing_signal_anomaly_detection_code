...
for i in np.arange(files.shape[0]):
    ...
    pl.title(u"10-LPC Coefficients Average of Diff Data within "+str(i_)+u"-"+str(i_+1)+" (Point at 6.1km)")

pl.subplots_adjust(hspace=0.6)
pl.savefig(u"10-LPC Coefficients Average of Diff Data of Point at 6.1km.jpg")
