...
for i in np.arange(files.shape[0]):
    ...
    if i_ == 14 or i_ == 16:
        ...
        pl.plot(t, data_lpc, color='green')
    else:
        pl.plot(t, data_lpc, color='blue')
    pl.title(u"10-LPC Coefficients Average of Diff Data within "+str(i_)+u"-"+str(i_+1)+" (Point at 15.1km)")

pl.subplots_adjust(hspace=0.6)
pl.savefig(u"10-LPC Coefficients Average of Diff Data of Point at 15.1km.jpg")
