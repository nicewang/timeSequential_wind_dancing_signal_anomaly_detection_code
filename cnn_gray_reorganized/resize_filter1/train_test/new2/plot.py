...
pl.title('Training Accuracy Rate Varies with Training Epochs\n'
         + '(Model3, Ratio of Normal and Abnormal is 21:1 in Training Set)')
...
data = np.genfromtxt("test_acc/count.txt")
data_abnormal = np.genfromtxt("test_acc/count_abnormal.txt")
...
data = np.genfromtxt("test_acc/count_abnormal.txt")
data_new = []
