...
pl.axvline(32,color='k',linewidth=0.5,linestyle="--")
...
pl.plot(data2/1238.0,linewidth=0.7,color='red',label='Training Accuracy')
pl.axvline(54,color='k',linewidth=0.5,linestyle="--")
